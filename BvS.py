...
#ALLEN, from here.........like I know whats gng on but cannot understand why they are doing these operations
loss=tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=operation,labels=tf.one_hot(label_ph,depth=2)))

train_step=tf.train.GradientDescentOptimizer(learning_rate=rate).minimize(loss=loss)
